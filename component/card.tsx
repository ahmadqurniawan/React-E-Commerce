...
const Card = () => {
    return (
        <div className="bg-white shadow-lg rounded-sm duration-100 hover:shadow-sm">
            <div className="h-[260px] w-auto rounded-t-sm relative">
                <Image src="/hero.jpg" width={384} height={256} alt="room iamge" className="w-full h-full object-cover rounded-t-sm" />
            </div>
            <div className="p-8">
